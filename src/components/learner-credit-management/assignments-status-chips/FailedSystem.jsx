...
const FailedSystem = ({ trackEvent }) => {
  ...
  const openChipModal = () => {
    open();
    trackEvent(BUDGET_DETAILS_ASSIGNED_DATATABLE_CHIP_FAILED_SYSTEM, { isOpen: !isOpen });
  };
  ...
  const helpCenterTrackEvent = () => {
    trackEvent(BUDGET_DETAILS_ASSIGNED_DATATABLE_CHIP_FAILED_SYSTEM_HELP_CENTER);
  };
