...
import { useSuccessfulAssignmentToastContextValue, useSuccessfulReminderToastContextValue } from './data';
...
const BudgetDetailPageWrapper = ({
  ...
  const values = useMemo(() => ({
    successfulAssignmentToast,
    successfulReminderToast,
  }), [successfulAssignmentToast, successfulReminderToast]);
  ...
  return (
    ...
    >
      ...
      {/**
        Successful assignment allocation, reminders, and cancellation Toast notifications. It is rendered
        ...
        modal. Thus, the Toast must be rendered within the component tree that's common to both the "Activity"
        and "Overview" tabs.
      */}
      <Toast
