...
describe('New SSO Config Card Tests', () => {
  it('has no accessibility violations', async () => {
    const { container } = renderWithI18nProvider(<NewSSOConfigCard
      config={{
        display_name: 'test', uuid: 'ecc16800-c1cc-4cdb-93aa-186f71b026ca', active: true, modified: '2021-08-05T15:00:00Z', validated_at: '2021-08-07T15:00:00Z', configured_at: '2021-08-06T15:00:00Z', submitted_at: '2021-08-05T15:00:00Z',
      }}
