...
describe("<DegreedConfig />", () => {
  ...
  //   expect(screen.findByText("Please enter a valid URL")).toBeInTheDocument();
  //   expect(screen.findByText("Display name should be 20 characters or less")).toBeInTheDocument();
  // });
