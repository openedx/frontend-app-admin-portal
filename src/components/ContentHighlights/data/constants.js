...
export const MAX_HIGHLIGHT_SETS_PER_ENTERPRISE_CURATION = process.env.MAX_HIGHLIGHT_SETS_PER_ENTERPRISE_CURATION
  ? parseInt(process.env.MAX_HIGHLIGHT_SETS_PER_ENTERPRISE_CURATION, 10) : 26;
