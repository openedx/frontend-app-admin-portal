...
export const CONTENT_HIGHLIGHTS_EVENTS = {
  ...
  STEPPER_CLOSE_HIGHLIGHT_MODAL: `${CONTENT_HIGHLIGHT_STEPPER_BASE_PREFIX}.close_stepper_modal`,
  STEPPER_STEP_CREATE_TITLE: `${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.create_title`,
  ...
  STEPPER_STEP_SELECT_CONTENT: `${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.select_content`,
  STEPPER_STEP_CONFIRM_CONTENT: `${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.confirm_content`,
  STEPPER_STEP_CONFIRM_CONTENT_DELETE: `${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.content_delete.clicked`,
  // Dashboard
  ...
  PUBLISH_HIGHLIGHT: `${CONTENT_HIGHLIGHT_STEPPER_BASE_PREFIX}.publish_content_highlight.clicked`,
};
