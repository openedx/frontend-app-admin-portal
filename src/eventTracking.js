...
export const CONTENT_HIGHLIGHTS_EVENTS = {
  // Deletion
  DELETE_HIGHLIGHT_BUTTON: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_DELETE_CONTENT_PREFIX}`,
  DELETE_HIGHLIGHT_CONFIRM: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_DELETE_CONTENT_PREFIX}.confirm`,
  DELETE_HIGHLIGHT_CANCEL: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_DELETE_CONTENT_PREFIX}.cancel`,
  // Stepper Actions
  STEPPER_HYPERLINK_CLICK: `${PROJECT_NAME}.${CONTENT_HIGHLIGHT_STEPPER_BASE_PREFIX}.help_center_program_optimization_hyperlink`,
  STEPPER_STEP_CREATE_TITLE: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.create_title`,
  STEPPER_SELECT_CONTENT_ABOUT_PAGE: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.select_content_about_page`,
  STEPPER_CONFIRM_CONTENT_ABOUT_PAGE: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.confirm_content_about_page`,
  STEPPER_CLOSE_STEPPER_INCOMPLETE: `${PROJECT_NAME}.${CONTENT_HIGHLIGHT_STEPPER_BASE_PREFIX}.close_without_saving`,
  STEPPER_STEP_SELECT_CONTENT: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.select_content`,
  STEPPER_STEP_CONFIRM_CONTENT: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_STEPPER_STEP_PREFIX}.confirm_content`,
  // Dashboard
  HIGHLIGHT_DASHBOARD_SET_ABOUT_PAGE: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_DASHBOARD_PREFIX}.set_item_about_page`,
  HIGHLIGHT_DASHBOARD_PUBLISHED_HIGHLIGHT_SET_CARD: `${PROJECT_NAME}.${CONTENT_HIGHLIGHTS_DASHBOARD_PREFIX}.published_highlight_set_card`,
  // Highlight Creation
  NEW_HIGHLIGHT: `${PROJECT_NAME}.create_new_content_highlight`,
  PUBLISH_HIGHLIGHT: `${PROJECT_NAME}.publish_content_highlight`,
};
