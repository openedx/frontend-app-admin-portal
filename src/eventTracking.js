...
export const LEARNER_CREDIT_MANAGEMENT_EVENTS = {
  ...
  // Activity tab approved requests table bulk remind
  BUDGET_DETAILS_APPROVED_REQUESTS_DATATABLE_OPEN_BULK_REMIND_MODAL: `${BUDGET_DETAIL_ACTIVITY_TAB_PREFIX}.approved_requests_table_bulk_remind_modal_open.clicked`,
  BUDGET_DETAILS_APPROVED_REQUESTS_DATATABLE_CLOSE_BULK_REMIND_MODAL: `${BUDGET_DETAIL_ACTIVITY_TAB_PREFIX}.approved_requests_table_bulk_remind_modal_close.clicked`,
  BUDGET_DETAILS_APPROVED_REQUESTS_DATATABLE_BULK_REMIND: `${BUDGET_DETAIL_ACTIVITY_TAB_PREFIX}.approved_requests_table_bulk_remind.clicked`,
  // Activity tab chips
  ...
  SUPPRESS_ASSIGNMENT_EMAIL_TOGGLED: `${BUDGET_DETAIL_ASSIGNMENT_MODAL_PREFIX}.suppress_assignment_email.toggled`,
  // Budget Expiry
