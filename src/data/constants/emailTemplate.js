...
const ALL_EMAIL_TEMPLATE_SUCCESS = 'ALL_EMAIL_TEMPLATE_SUCCESS';
const SAVE_TEMPLATE_FAILURE = 'SAVE_TEMPLATE_FAILURE';
const SET_EMAIL_TEMPLATE_SOURCE = 'SET_EMAIL_TEMPLATE_SOURCE';
const ADD_NEW_TO_ALL_TEMPLATES_SUCCESS = 'ADD_NEW_TO_ALL_TEMPLATES_SUCCESS';
const UPDATE_ALL_TEMPLATES_SUCCESS = 'UPDATE_ALL_TEMPLATES_SUCCESS';
